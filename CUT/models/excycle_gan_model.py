...
class ExCycleGANModel(BaseModel):
    """
    ...
    def __init__(self, opt):
        ...
        visual_names_A = ['real_A', 'fake_B', 'rec_A','real_A_sig','fake_B_sig']
    ...
    def forward(self):
        ...
        self.real_A_sig = torch.sigmoid(real_A_normal)
        self.real_B_sig = torch.sigmoid(real_B_normal)
        self.fake_A_sig = torch.sigmoid(fake_A_normal)
        self.fake_B_sig = torch.sigmoid(fake_B_normal)
